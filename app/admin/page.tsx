...
interface TeamData {
  ...
  pendingCount: number;
  limit: number;
  members: { id: string; name: string | null; email: string | null; teamRole: string }[];
...
export default function AdminDashboard() {
  ...
  if (loading) return <div className="min-h-screen bg-slate-50 flex items-center justify-center font-bold text-blue-600">Chargement...</div>;
  if (error) return (
