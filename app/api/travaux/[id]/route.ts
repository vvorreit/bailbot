...
export async function PUT(
  ...
  const travaux = await prisma.travaux.update({
    ...
    data: {
      ...
      montantDevis: body.montantDevis !== undefined ? (body.montantDevis ? parseFloat(body.montantDevis) : null) : existing.montantDevis,
      montantReel: body.montantReel !== undefined ? (body.montantReel ? parseFloat(body.montantReel) : null) : existing.montantReel,
